...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Log-3.0.7.xcframework.zip",
			checksum: "e41cb0ac2b9f1084831ce008e034d1a7d05978638d717240f1662e05121a3d64"
		)
	]
)