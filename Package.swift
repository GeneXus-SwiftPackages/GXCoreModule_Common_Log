...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.2.0-beta.25.xcframework.zip",
			checksum: "741c558a0391c5ada283e308f4b40ba3dc0b84b0fdddebbdd0d899676cc8b3fc"
		)
	]
)