...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-5.0.0-beta.5.xcframework.zip",
			checksum: "57908fb5149aa24fb8ef274f494a9ab753c8f0229aea6ad70e8cf425fd5b39e7"
		)
	]
)