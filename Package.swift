...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-4.0.0-beta.47.xcframework.zip",
			checksum: "19726800c076d9b9579575b8ba39d85f5a75a6ca020bb51ae77138e8dc16a207"
		)
	]
)