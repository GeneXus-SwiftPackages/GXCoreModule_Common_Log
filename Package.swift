...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-4.1.0-beta.11.xcframework.zip",
			checksum: "bf71e4c0ef10fee262acec5db8d6756762abbdcdb8aaf19508d064b72548829a"
		)
	]
)