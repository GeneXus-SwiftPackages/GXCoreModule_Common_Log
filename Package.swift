...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_Log-1.4.0-rc.10.xcframework.zip",
			checksum: "074d7f57d4be511d7f1d939e3b6c607738dfc9dcdb2f4f55cb34060d45c57ce2"
		)
	]
)