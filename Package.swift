...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-2.0.0-beta.25.xcframework.zip",
			checksum: "a4dcda87c1ee5e67a7d9d6914a976b153c093949a59a57c60e3ce3c2a5950b03"
		)
	]
)