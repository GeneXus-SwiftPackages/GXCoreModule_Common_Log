...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.2.0-beta.19.xcframework.zip",
			checksum: "fa2595a58f0deec4aeb0a41dc2d1f97e9337a979bd9240f8322df7eb01277e30"
		)
	]
)