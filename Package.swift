...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.2.0-beta.36.xcframework.zip",
			checksum: "9d3b73a6be9efa3f2e19c43db17bf52d90421a182f89514696a965a560169734"
		)
	]
)