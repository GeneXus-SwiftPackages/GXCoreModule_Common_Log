...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.1.0-beta.27.xcframework.zip",
			checksum: "8e7c06968146dbbd835903b2e26db56fe7a6b34cd205dcfe30530186253d84d9"
		)
	]
)