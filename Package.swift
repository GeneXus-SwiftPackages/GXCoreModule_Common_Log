...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.2.0-beta.28.xcframework.zip",
			checksum: "f8d598a5d717915590526c83936402272df30d356ebc18d5321aaa2388a5c65d"
		)
	]
)