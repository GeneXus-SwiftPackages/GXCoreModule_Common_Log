...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.6.0-beta.4.xcframework.zip",
			checksum: "cd469339da4ff52cc7e8ee4683cab88daea1e0a041a5694896fcce950fb711e7"
		)
	]
)