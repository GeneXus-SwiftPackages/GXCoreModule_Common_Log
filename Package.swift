...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.2.0-beta.20.xcframework.zip",
			checksum: "0de040a561740b57c817a4c844cca320f5bc8c48f540cabbd1f1b78626901804"
		)
	]
)