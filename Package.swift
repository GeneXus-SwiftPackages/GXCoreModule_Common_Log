...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_Log-5.0.0-rc.0.xcframework.zip",
			checksum: "c4500aa9a98f0edc2314c2f07696aee25925598b7b4ba4dd41aba5f516a3cb59"
		)
	]
)