...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-4.2.0-beta.37.xcframework.zip",
			checksum: "bd6bb7a113cbd91b8aebb06fc87ecb06f1365946833edcecaa901bfdc73ed18b"
		)
	]
)