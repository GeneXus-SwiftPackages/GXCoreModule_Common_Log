...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-2.0.0-beta.21.xcframework.zip",
			checksum: "5c3f500e80573106823565b4e93b8ac85708a209cc5e0d10895b602c3d5f12f8"
		)
	]
)