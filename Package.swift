...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-4.2.0-beta.1.xcframework.zip",
			checksum: "a831bd1109527b6979e4c3d5de3ae1afa8eba08d392fa435f14950ba1be4c55d"
		)
	]
)