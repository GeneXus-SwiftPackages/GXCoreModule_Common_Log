...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.2.0-beta.21.xcframework.zip",
			checksum: "81dbae3bccc2704bf9e870bba84b480a7392dd3a3a66d01a8ad1375e7babac22"
		)
	]
)