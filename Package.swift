...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.4.0-beta.3.xcframework.zip",
			checksum: "097fd1c81efbe18da2e4e1b0b12fab423e211b4a92de1f0c91670578ba9a7506"
		)
	]
)