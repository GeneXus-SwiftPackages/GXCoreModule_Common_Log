...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.2.0-beta.10.xcframework.zip",
			checksum: "9a5473abe1d43738af2636771a5af78664aeff082775f78f864864f6660823e5"
		)
	]
)