...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-2.2.0-beta.13.xcframework.zip",
			checksum: "22f77922fdf27c4d5edbead19e09fefa8dd3bd4d2749821fc80119ecb011902b"
		)
	]
)