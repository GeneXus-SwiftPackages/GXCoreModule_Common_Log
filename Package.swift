...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Log-4.0.5.xcframework.zip",
			checksum: "fc0e2d842a61cd508825ea184aa16befe2d4f11406b6c177bf5d33fa658db90d"
		)
	]
)