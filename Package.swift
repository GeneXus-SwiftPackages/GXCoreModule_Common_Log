...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.2.0-beta.30.xcframework.zip",
			checksum: "6b30c01b1ab3b787231717f0df29a5b6be26da682d8e4dff45bef04205595c4a"
		)
	]
)