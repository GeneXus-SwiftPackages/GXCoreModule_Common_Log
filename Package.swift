...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Log-1.5.11.xcframework.zip",
			checksum: "d65a2ad5ebf1b715d0420fafb4265d70c1ebebef24ea4ad7b6ed3c5f14ce94c6"
		)
	]
)