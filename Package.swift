...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-4.2.0-beta.7.xcframework.zip",
			checksum: "0fbb628eca61895a23c9b99bc6fffd90b6d8f5e6378c4fca0457604654af4b70"
		)
	]
)