...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_Log-3.0.0-rc.8.xcframework.zip",
			checksum: "4a6862a2c4ab6c8595c44b2de1af335cb0bbcd9a41574a1e70c83f686af91e4c"
		)
	]
)