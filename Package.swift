...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_Log-2.2.0-rc.3.xcframework.zip",
			checksum: "8d7645c93bfc680290d3ab69ed3bb209a4c1b0e3e05cfa5c4d263ee613658c70"
		)
	]
)