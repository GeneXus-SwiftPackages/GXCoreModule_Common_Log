...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Log-3.2.0.xcframework.zip",
			checksum: "d9a9e68c1227f7ca2cfb4c1bdc661d05805b58eea0ce481fd7897f19b83d9d4f"
		)
	]
)