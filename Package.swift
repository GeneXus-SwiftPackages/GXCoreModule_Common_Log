...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-2.0.0-beta.27.xcframework.zip",
			checksum: "5ba46cd82030363ef63ea89558f65725035723fd4600a94494d42241259d20c8"
		)
	]
)