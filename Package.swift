...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_Log-4.1.0-rc.24.xcframework.zip",
			checksum: "27e2e07e0fb329dc4ff2b3b6a54803e0fc97865237ca0edf01406cb48068ed9f"
		)
	]
)