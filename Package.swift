...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Log-3.1.0.xcframework.zip",
			checksum: "947598831a0e0357d152dfdc027306425758f75023e414570d9c7370ff51d505"
		)
	]
)