...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.0.0-beta.4.xcframework.zip",
			checksum: "cbb296322e32333223700fd9f0e0667bfde81d1bc76aeefae16668958e0fb0a1"
		)
	]
)