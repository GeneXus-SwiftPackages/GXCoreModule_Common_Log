...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.2.0-beta.27.xcframework.zip",
			checksum: "42656de9300bdf7c5265783b8efaa2e89a53e99cce6a615597cd9feae8a01ce7"
		)
	]
)