...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_Log-3.2.0-rc.0.xcframework.zip",
			checksum: "c05260ac7d3dff5fc41a301b50e5ff0bea0bcafc0a3570ba9c1bd0cab64b21ad"
		)
	]
)