...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.5.0-beta.10.xcframework.zip",
			checksum: "9b7b679d0396d01f51cc906d267bd637fa3b498a1c562d7edf2210d0901eafc8"
		)
	]
)