...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-4.1.0-beta.23.xcframework.zip",
			checksum: "040cdd4ac7fbe1bbeec5ffcac01a8fc957232fae574ed6f619a02052ef045855"
		)
	]
)