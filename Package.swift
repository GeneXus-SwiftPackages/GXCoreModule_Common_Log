...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-4.2.0-beta.33.xcframework.zip",
			checksum: "46814931f23b3a77a0fb5a472d138fbcd1a673b9ed2057da148a81eff31d0a29"
		)
	]
)