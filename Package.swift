...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.4.0-beta.12.xcframework.zip",
			checksum: "54aa16aa3c210668a20d826e3f3282fc3d814831b5538bbe81c135b90b465f48"
		)
	]
)