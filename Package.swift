...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.2.0-beta.12.xcframework.zip",
			checksum: "9aaec3f9806ba35e189d725e9ce90e071f5742fb4ff9a8e3037effab3268525e"
		)
	]
)