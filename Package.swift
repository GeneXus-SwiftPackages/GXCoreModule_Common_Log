...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Log-3.1.5.xcframework.zip",
			checksum: "953dc43085b1ae890382f6db5de99fa70368fbb9b603a3045c7c68c1c07a034c"
		)
	]
)