...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_Log-4.2.0-rc.37.xcframework.zip",
			checksum: "d966867758f3f0d71b3277537e12e6501d04f4eb3a84c7982ccee5236af1cabd"
		)
	]
)