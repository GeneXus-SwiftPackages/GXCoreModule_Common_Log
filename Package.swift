...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-2.0.0-beta.18.xcframework.zip",
			checksum: "0a3ca5141ad7be7bb42817f2056fd213fdd94318b460de816c92db531f39bb88"
		)
	]
)