...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.4.0-beta.17.xcframework.zip",
			checksum: "71778684023eeb9e0e6e3a23af59b8b9fe84d26a4b80d0089fa1741667e8a876"
		)
	]
)