...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.5.0-beta.24.xcframework.zip",
			checksum: "740fad955caa792b217330a07cc09818434607912f78e9dc5756e6316e3b6e9e"
		)
	]
)