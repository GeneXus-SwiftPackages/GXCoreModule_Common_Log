...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.2.0-beta.17.xcframework.zip",
			checksum: "b0e790a33739b95439fdb1b7db420d5c32a808bdcbcdf4fe4f85c528033cfaea"
		)
	]
)