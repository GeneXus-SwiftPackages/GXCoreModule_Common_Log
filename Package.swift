...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Log-3.0.2.xcframework.zip",
			checksum: "dc82c9d05e70cbcd8bb97212cb7949b845d6555cbe7f588adc1a104e3c930722"
		)
	]
)