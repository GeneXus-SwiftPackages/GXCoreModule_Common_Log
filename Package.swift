...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_Log-1.5.0-rc.28.xcframework.zip",
			checksum: "0ad6dca4f2a56c82a65f821de5fc058fd36708ac34879275e3fa16f1cfd37081"
		)
	]
)