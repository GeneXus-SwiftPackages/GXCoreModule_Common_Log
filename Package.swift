...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.2.0-beta.37.xcframework.zip",
			checksum: "c80c761d7f4f10029b82827b066702f8af36474395614e1a84fb400106666d1f"
		)
	]
)