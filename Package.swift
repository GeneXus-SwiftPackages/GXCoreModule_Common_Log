...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.5.0-beta.27.xcframework.zip",
			checksum: "82860a1a24d8dd1b816a6413d465f7e4247c57eacea723ec6b8b8537ece12d8a"
		)
	]
)