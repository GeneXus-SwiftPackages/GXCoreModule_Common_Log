...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-4.2.0-beta.20.xcframework.zip",
			checksum: "e7dae9e3739f21246b414c69cba93b6e84f0c6705ce5dd367f6e538db91f2a85"
		)
	]
)