...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.0.0-beta.8.xcframework.zip",
			checksum: "341a44b4a9a4f3731648d5b470decbfab90c1b95b55c2b87d0c8462356bd42b3"
		)
	]
)