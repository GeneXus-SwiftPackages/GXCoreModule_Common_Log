...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.5.0-beta.18.xcframework.zip",
			checksum: "227e60d669588c85f10cc487a071be94e2645a6df3bc6107ae7b2c195fbf93dc"
		)
	]
)