...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-4.1.0-beta.10.xcframework.zip",
			checksum: "222d98610cabcef6568bca98199853e5e0aa8a78a41180f05d1342886692c83e"
		)
	]
)