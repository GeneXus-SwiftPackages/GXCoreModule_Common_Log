...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.2.0-beta.34.xcframework.zip",
			checksum: "0e627b1f601a9f73c81e46c9461305e037127197a0ce002b0118e82ea117cf33"
		)
	]
)