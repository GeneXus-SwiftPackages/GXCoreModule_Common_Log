...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Log-4.0.6.xcframework.zip",
			checksum: "b2ca36b941f35dd4a04e33dbb7ea74e4c54377558e52b62931e83d95884fd791"
		)
	]
)