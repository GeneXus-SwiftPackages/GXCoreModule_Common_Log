...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.1.0-beta.18.xcframework.zip",
			checksum: "8efa19e38b940465f80e7e98afa08f7d840c8a86de49dc3b1be441efa8fd3f7c"
		)
	]
)