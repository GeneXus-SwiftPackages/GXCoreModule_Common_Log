...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.1.0-beta.3.xcframework.zip",
			checksum: "0c981453f77b24b137f5b9b6383f847c3857ceffc4f26ac1ea810b751533e442"
		)
	]
)