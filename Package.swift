...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.1.0-beta.4.xcframework.zip",
			checksum: "a971286bd88c19e403cb7e56979e785fc3e158736544f96327a310b11b5b6185"
		)
	]
)