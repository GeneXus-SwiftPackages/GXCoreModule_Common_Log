...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Log-4.0.4.xcframework.zip",
			checksum: "0fcaa1cc123a188ec26506196edee249b64ce0e96f54292b99e91d479812b4f5"
		)
	]
)