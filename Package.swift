...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-4.1.0-beta.2.xcframework.zip",
			checksum: "e5a26023cae9d79e1ce0fae1e75d721b88f8a4a086bf5ea874f29fd5b0848f84"
		)
	]
)