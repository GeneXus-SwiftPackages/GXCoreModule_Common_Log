...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.5.0-beta.4.xcframework.zip",
			checksum: "e4b7b34617dd0f60397b7b531618cb423b732b43fbfb9e4964c9067cc149dbdd"
		)
	]
)