...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_Log-1.3.0-rc.7.xcframework.zip",
			checksum: "bb5c7b57354d15bdfee3e20bf9edaeb22d50d4c3d61fde4b3247887dd817fc1a"
		)
	]
)