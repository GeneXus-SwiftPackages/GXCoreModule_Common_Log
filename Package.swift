...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_Log-1.1.0-rc.5.xcframework.zip",
			checksum: "c58373d1de6cb92f6bf5f3911c1c1d8dbe82611101771bd6dc651649e50482c9"
		)
	]
)