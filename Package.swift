...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_Log-1.2.0-rc.25.xcframework.zip",
			checksum: "d7231506bec8637d44c928e34e024bd45b3e406bd202f9a1289a974caf3577fe"
		)
	]
)