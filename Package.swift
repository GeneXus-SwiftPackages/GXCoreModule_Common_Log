...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-4.2.0-beta.23.xcframework.zip",
			checksum: "1b4ad7be737dd194798e6783e4615a3d7f90570562a563f6859372496c5e72be"
		)
	]
)