...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.2.0-beta.37.xcframework.zip",
			checksum: "74ebd7737ad73cdf811ea13a11c0610c075e9949bfa93260b748556a9d086e18"
		)
	]
)