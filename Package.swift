...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.2.0-beta.35.xcframework.zip",
			checksum: "94cd3e1f95399bb56cc163597a0bef085695acede1f9b9b34a8ca76402a67335"
		)
	]
)