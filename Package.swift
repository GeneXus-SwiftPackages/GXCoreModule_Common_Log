...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_Log-5.0.0-rc.1.xcframework.zip",
			checksum: "d9a6c628583b2afd956400db1a8bd301192be90b76296c34e8fe892d6b900cbb"
		)
	]
)