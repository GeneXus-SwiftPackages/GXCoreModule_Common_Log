...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_Log-3.0.0-rc.2.xcframework.zip",
			checksum: "a0a2d91ec85eda95a94e6fff02a841efbe6f8ddd13899a9242138a0aa4caae6a"
		)
	]
)