...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.1.0-beta.8.xcframework.zip",
			checksum: "24d29d24330a76462300300e085c7ef9f9b0387e71947cc1fee7f5902afbe9e0"
		)
	]
)