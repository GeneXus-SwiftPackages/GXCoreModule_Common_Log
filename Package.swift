...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Log-1.1.0-rc.1.xcframework.zip",
			checksum: "08dc085289a65e914ccc53d763d9c4c810b0948981f6962a4742230007f726de"
		)
	]
)