...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-2.0.0-beta.30.xcframework.zip",
			checksum: "7fc4e3fa1a9a66401b58c206c8c8bfc5a71274400f50d190382f96041212c27d"
		)
	]
)