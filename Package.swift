...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_Log-2.0.0-rc.34.xcframework.zip",
			checksum: "11391c0ef825c2338517cb945a646244695e5407356f887d82c8fc4f3f231ded"
		)
	]
)