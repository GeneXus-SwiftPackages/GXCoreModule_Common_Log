...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-4.1.0-beta.22.xcframework.zip",
			checksum: "3c42d84e059278f36991e18fde8affb55c7457fc09022a8bafdfe009925d81f3"
		)
	]
)