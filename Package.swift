...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.2.0-beta.31.xcframework.zip",
			checksum: "b42710f0726eb44691805f74fce773bf8604cff8f2cae88df0e6567b18601629"
		)
	]
)