...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Log-1.5.12.xcframework.zip",
			checksum: "222729c6e226fbbcddbec55be79d7382915ed357547bd251de6ffe1dab06f923"
		)
	]
)