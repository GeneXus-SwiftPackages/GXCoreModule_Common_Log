...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.3.0-beta.6.xcframework.zip",
			checksum: "d869b4b51c6ace1d44bdc79c62630cf185421e8dea65ca49c7a0e12f4b099bd0"
		)
	]
)