...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Log-4.1.1.xcframework.zip",
			checksum: "4fe552dfe7a9408225fd2034add07f07f860f77e04ac3b0eece67cea8aaa629b"
		)
	]
)