...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-2.0.0-beta.39.xcframework.zip",
			checksum: "e744ff8b6a6fd10bf60961ffc995315cc00f06a35c6c488fe39b9da9e8849d2c"
		)
	]
)