...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.2.0-beta.28.xcframework.zip",
			checksum: "aae12fedbe2511fd66f12ba23165b463155b6cb508b3c038387cd0889e8d91d2"
		)
	]
)