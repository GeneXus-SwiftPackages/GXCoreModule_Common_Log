...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-2.2.0-beta.11.xcframework.zip",
			checksum: "7a859b46ea842fbccb2d84d10231258268f0152cfbeed2d7273103eeac4aa5e1"
		)
	]
)