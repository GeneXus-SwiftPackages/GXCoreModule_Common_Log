...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.0.0-beta.17.xcframework.zip",
			checksum: "45350072bdf41b46b00c27228b9349b21a324700a4069dbb4027922bed8812d1"
		)
	]
)