...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Log-1.3.0.xcframework.zip",
			checksum: "dfe7e187e24aa13b82865cafd4b471a43992599554e4a8c6d60941a585311fb5"
		)
	]
)