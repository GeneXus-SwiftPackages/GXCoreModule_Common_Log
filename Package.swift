...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-4.2.0-beta.39.xcframework.zip",
			checksum: "5d93ace77890c9b73b3945f6b58f40c65d84578b9fcf31ce83fb4f7662a46811"
		)
	]
)