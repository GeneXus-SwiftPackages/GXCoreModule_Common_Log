...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-2.0.0-beta.36.xcframework.zip",
			checksum: "47bbe2418975e1ac4cb57cea9847210527691cea2dd382a721cf63068b920d62"
		)
	]
)