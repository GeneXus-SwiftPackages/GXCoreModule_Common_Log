...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.3.0-beta.7.xcframework.zip",
			checksum: "4ad80e5bf269906280014cfd667070e5ec6e9e3b77863422aaefd823d46c8471"
		)
	]
)