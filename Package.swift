...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-2.0.0-beta.6.xcframework.zip",
			checksum: "93f8e847fe2c1b9b3c6b563dd8ac3d617c5080719a412f9e9971388cf360ce31"
		)
	]
)