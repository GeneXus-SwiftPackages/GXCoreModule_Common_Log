...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Log-1.4.29.xcframework.zip",
			checksum: "d24a3b0eb60710cb13af579844f91bab41abc8c8ff9a583c91bfe800bf1fafc3"
		)
	]
)