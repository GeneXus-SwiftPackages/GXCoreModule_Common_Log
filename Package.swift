...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.1.0-beta.7.xcframework.zip",
			checksum: "0fc8875913b0b50d1c3b20c12dce39f66eb11089a5c9a838de07f51fb8a0ed29"
		)
	]
)