...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.2.0-beta.29.xcframework.zip",
			checksum: "2aef68c6cf2380bdd8a66a16903e10aebee138ddd126f30d9e46351baa384155"
		)
	]
)