...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Log-1.1.3.xcframework.zip",
			checksum: "af22c8ccbd97dd6ee37e862761776dc48d3b3d60e0cf0043d37515e2d31f7546"
		)
	]
)