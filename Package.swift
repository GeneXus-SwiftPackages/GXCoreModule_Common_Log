...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.4.0-beta.19.xcframework.zip",
			checksum: "2e9c92348ca9bd121451f8f55c75e8c15bac9f818ee27e7ff9f5a3ef673ee2a7"
		)
	]
)