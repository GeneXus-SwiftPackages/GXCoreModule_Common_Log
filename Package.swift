...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-2.2.0-beta.9.xcframework.zip",
			checksum: "b7e76c2492e27f68d184c05682a011c5394d384d0dd55dbf03eace90aa3712ef"
		)
	]
)