...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.5.0-beta.13.xcframework.zip",
			checksum: "42855a80aa05c1bbfef2ef13303ff4d198b8079c023c7eb51aaf42f3ac47b023"
		)
	]
)