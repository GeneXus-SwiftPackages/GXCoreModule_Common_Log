...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.2.0-beta.33.xcframework.zip",
			checksum: "fb8bb20a999d70cc26814e51b62f9549df5d4a40825dc4e4d6cb7582a6635c9e"
		)
	]
)