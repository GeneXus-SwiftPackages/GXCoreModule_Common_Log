...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.2.0-beta.24.xcframework.zip",
			checksum: "278b4b1d17c231c0ee0debbb1362214af0405908b23ac0485cdc8f135f456622"
		)
	]
)