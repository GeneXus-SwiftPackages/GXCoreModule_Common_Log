...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Log-1.4.27.xcframework.zip",
			checksum: "0505d60debbf2894827c18849b585b1d150a287b64f6ae4261641dfad3cba7ae"
		)
	]
)