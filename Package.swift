...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.0.0-beta.13.xcframework.zip",
			checksum: "9578e28887afbc974d1f8bf7f682e55ba894a9d503c789c8d2fdac536a2b5d8d"
		)
	]
)