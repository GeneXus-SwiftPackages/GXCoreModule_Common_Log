...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.1.0-beta.25.xcframework.zip",
			checksum: "2f6ac0e5dbf0c43f1ab897dd996927bc28b330a52bf2864304b34270fdfb8304"
		)
	]
)