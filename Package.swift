...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-4.0.0-beta.49.xcframework.zip",
			checksum: "14d9c1c4917a0ae54dc4f04dbb15e82d5fc43954cb3f66d8c8ed42e6b1bd4571"
		)
	]
)