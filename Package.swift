...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.5.0-beta.21.xcframework.zip",
			checksum: "511d2d354ec7d92973081047b9ff02144590b13deb71881aa30ab387d38e9c44"
		)
	]
)