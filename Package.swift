...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_Log-3.1.0-rc.3.xcframework.zip",
			checksum: "10248e6df121e3a88790b16effa67cb0a74184516254ce69b7aa353c6712fada"
		)
	]
)