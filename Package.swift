...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.1.0-beta.13.xcframework.zip",
			checksum: "6c9e6eb88019652b35e913c9a182ad9f074ba2fc1571a5fa5e22b01db9c01e2c"
		)
	]
)