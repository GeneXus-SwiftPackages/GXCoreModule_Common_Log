...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.3.0-beta.5.xcframework.zip",
			checksum: "9043f1d0de049ce0ad81ccff3e78f8c6390767c440fc4f6d01f3352e03015d63"
		)
	]
)