...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.2.0-beta.23.xcframework.zip",
			checksum: "7df3c0ec47e04ca0e76fd2a57b144262327bc58dff1da9dd20b3b85cca7c238e"
		)
	]
)