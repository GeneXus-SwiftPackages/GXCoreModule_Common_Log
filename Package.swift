...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Log-4.1.3.xcframework.zip",
			checksum: "52a67a3c3313ede8c29ad2296281922c9d1e9b1cbfa9c702e7c54aad25c37e82"
		)
	]
)