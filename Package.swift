...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_Log-1.3.0-rc.1.xcframework.zip",
			checksum: "e53acb88ae5ea3f29a9592a944bf1f11bdb7b55c45d8b3a18366e6d183e2f21d"
		)
	]
)