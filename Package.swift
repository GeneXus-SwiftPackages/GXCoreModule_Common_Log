...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Log-1.4.26.xcframework.zip",
			checksum: "6451c1e28a6757f606fcd3a09425ce594e6fc452f8392302e943df1855d5df86"
		)
	]
)