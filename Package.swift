...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-2.2.0-beta.10.xcframework.zip",
			checksum: "d50402e1dc4b0f56fa45e172edb5967913a2cc4fb83ead39df6a1aa43e90a05e"
		)
	]
)