...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.1.0-beta.19.xcframework.zip",
			checksum: "0951dc0f0bed00adab62e8eb60c519d9055e140b4bff47f776295a61f1cea4bd"
		)
	]
)