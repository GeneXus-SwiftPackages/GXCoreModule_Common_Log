...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.4.0-beta.14.xcframework.zip",
			checksum: "54c2f69995f8655d8c236635858355272cefb0e8e2afbce8529cbdd4e6afa777"
		)
	]
)