...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.1.0-beta.31.xcframework.zip",
			checksum: "ee5c4216bf1939c2cd539901c5e5e035f8457cf982598010a84ffa951addeefc"
		)
	]
)