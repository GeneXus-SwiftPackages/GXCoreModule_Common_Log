...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-4.2.0-beta.25.xcframework.zip",
			checksum: "485c05237d199685e91f3cb6848f40136a9ed042ee52f7817d1e15302dfbeb10"
		)
	]
)