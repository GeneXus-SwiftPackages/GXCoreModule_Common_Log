...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-2.0.0-beta.37.xcframework.zip",
			checksum: "092829f90789d6982c395eb00c2eefeaf7f7e6783aa3a9d91bc3c8e70e5a1d70"
		)
	]
)