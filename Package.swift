...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.1.0-beta.16.xcframework.zip",
			checksum: "82e2bb9735424faa6ceee55ac49381b62ee255fafa9c01786a1a41aaf3cecb75"
		)
	]
)