...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_Log-1.2.0-rc.15.xcframework.zip",
			checksum: "c5ca49337f0c88c80f53beda2965baac8babedac51a108f836c68e55b7047aa3"
		)
	]
)