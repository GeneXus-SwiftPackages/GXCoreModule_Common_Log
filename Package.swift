...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.0.0-beta.9.xcframework.zip",
			checksum: "b193327b0d3faed21c2171fb41dc4b59b3de6e2d12e9596c207f615ade304788"
		)
	]
)