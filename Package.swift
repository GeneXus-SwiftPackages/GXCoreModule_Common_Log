...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_Log-1.2.0-rc.1.xcframework.zip",
			checksum: "e1803462aef99f37057c6f50223d544a545c1202e87a8ac57c6badab12a1c5aa"
		)
	]
)