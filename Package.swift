...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-4.2.0-beta.27.xcframework.zip",
			checksum: "a159b46389b8da996dfc9932d55808bcf57e598a786428bb426cc868370d0d1b"
		)
	]
)