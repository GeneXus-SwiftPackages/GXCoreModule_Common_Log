...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-5.0.0-beta.1.xcframework.zip",
			checksum: "fe9e8e6f953f955bb5f87aea5d37afc043f17d1a35632888cedd4d519f7d8c02"
		)
	]
)