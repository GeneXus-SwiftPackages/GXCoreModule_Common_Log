...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Log-4.0.17.xcframework.zip",
			checksum: "142bf7a6dfe32dd1dfaf4dd90b4256c111c9b92402914fcca6a0058ad49a5ad8"
		)
	]
)