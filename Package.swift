...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.3.0-beta.3.xcframework.zip",
			checksum: "b13f1af1f36fdd2a1568ce06a80ee6b060b3ba2dffc2391f466036bdc12ac576"
		)
	]
)