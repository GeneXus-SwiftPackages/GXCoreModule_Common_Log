...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-4.2.0-beta.18.xcframework.zip",
			checksum: "db9f393d41ee379c6e429f012207126479a8201f0e1316809478ab75e321cc06"
		)
	]
)