...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.2.0-beta.41.xcframework.zip",
			checksum: "89d8f384c2a09e58c6d518c9ee1c2c0d985997b028f3b0c11fba841fd8b719e5"
		)
	]
)