...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.1.0-beta.0.xcframework.zip",
			checksum: "a02f32e6089fd3fcc1233b576c13697e8c7c66209e44bdb642a6ecbc01062e52"
		)
	]
)