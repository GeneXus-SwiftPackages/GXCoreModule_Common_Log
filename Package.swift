...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Log-1.3.6.xcframework.zip",
			checksum: "e626a899c0feac73a412c157a6fde233c8e3c441971934eb98102ba46427e0d3"
		)
	]
)