...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.5.0-beta.9.xcframework.zip",
			checksum: "4beaaa1e114bc595be7f2ce9aefb7b30591330f124a3653688ab7f18f03e6343"
		)
	]
)