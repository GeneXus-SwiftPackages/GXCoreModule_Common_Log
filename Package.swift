...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_Log-1.3.0-rc.13.xcframework.zip",
			checksum: "e0fb207b1ce17daca430f9479b7240ab0c54a849a75e909ca9c0ff808daf9785"
		)
	]
)