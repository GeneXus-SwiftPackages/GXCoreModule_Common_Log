...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Log-2.0.12.xcframework.zip",
			checksum: "58709dd159e6f06d16fa1e056fd9253e2f1cf7122d14e42ad00d65b68c1194ed"
		)
	]
)