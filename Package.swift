...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.4.0-beta.7.xcframework.zip",
			checksum: "79fc93853b14e8bf2e3297ac1cc2e5fdef27898cc15cf86bf71587f00b0848d7"
		)
	]
)