...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-2.0.0-beta.7.xcframework.zip",
			checksum: "5b08a2deaf4f8867907ad4cb1c366585a34db9ef7278dbba5c4ee9f5a07de71f"
		)
	]
)