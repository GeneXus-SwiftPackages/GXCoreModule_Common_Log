...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_Log-4.2.0-rc.3.xcframework.zip",
			checksum: "351066643cab8a1e46dc981dccebfea8f50b34eb22589059f92312d1f2199154"
		)
	]
)