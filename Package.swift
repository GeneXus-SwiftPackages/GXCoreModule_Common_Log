...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-2.0.0-beta.26.xcframework.zip",
			checksum: "d36bfc07936cd3ec7905f8fb59ae66e49ffbb7a88bfcca95e3112471e8e29714"
		)
	]
)