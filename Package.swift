...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Log-2.1.0.xcframework.zip",
			checksum: "77a2bb46e525b33a17953c599b2b70ca44aab819c18e8095eb98435ac76b3048"
		)
	]
)