...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.2.0-beta.22.xcframework.zip",
			checksum: "cab669b5f91358929bc5c5d52cb524bdd4a3771f67df3d2563dccbf2f4bab6ab"
		)
	]
)