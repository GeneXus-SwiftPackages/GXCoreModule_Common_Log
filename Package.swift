...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-5.0.0-beta.6.xcframework.zip",
			checksum: "adcf58bce9862b40a444632b3dc52c58c4a3fb3cd8cb6c9091668f874bfc4520"
		)
	]
)