...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.1.0-beta.12.xcframework.zip",
			checksum: "870008a1eb16fedc4a2cfcdb122a8e3c69cd67622ca51160687e3c40914bbaa2"
		)
	]
)