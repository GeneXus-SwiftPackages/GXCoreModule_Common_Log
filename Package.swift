...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-2.2.0-beta.26.xcframework.zip",
			checksum: "cb30294c951c5a4ff765cc118aa0672a6b50dedd6ffa2a8868320af01be9bdfc"
		)
	]
)