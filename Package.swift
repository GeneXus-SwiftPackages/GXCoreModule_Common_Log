...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_Log-4.2.0-rc.34.xcframework.zip",
			checksum: "0ceca5b27807b2da716ccd48626e86b4baa215ca54ff182294a45d0947b2bd7a"
		)
	]
)