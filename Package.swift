...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-2.0.0-beta.5.xcframework.zip",
			checksum: "fd5cdfe11fd529467f590f3acde5d443a466a671125a9b6f4071dad445fc6992"
		)
	]
)