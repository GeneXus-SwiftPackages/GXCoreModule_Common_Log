...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Log-4.1.5.xcframework.zip",
			checksum: "7ce743ce8c216e7a978ab4936df66b34f05ea65ada13d6655aa7f9130c6c234d"
		)
	]
)