...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.3.0-beta.8.xcframework.zip",
			checksum: "b398f48d5d5fdb7814bcf1b5161d4e1ba1ee63773d89a73e79203338df2709a3"
		)
	]
)