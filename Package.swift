...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.1.0-beta.9.xcframework.zip",
			checksum: "2150073906a2f344b71b6115cc4439ec86488c4d359d9504007f66c0e3d065d6"
		)
	]
)