...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.1.0-beta.2.xcframework.zip",
			checksum: "f61b62a595af9ac76fc2e7211c2e4c23a5bb6335c3cc54a04757739e9f8854c5"
		)
	]
)