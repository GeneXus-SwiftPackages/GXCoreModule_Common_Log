...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Log-1.1.2.xcframework.zip",
			checksum: "4cee983b1028e04b38dfac32e1d7330b9b6a8660d9883af57b37cd81e287673f"
		)
	]
)