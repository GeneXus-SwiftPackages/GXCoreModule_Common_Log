...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-4.0.0-beta.44.xcframework.zip",
			checksum: "8f78d86ccc4dc210215803ed9863ed2610deae36bf3ff1e7f40edc9a7302efa6"
		)
	]
)