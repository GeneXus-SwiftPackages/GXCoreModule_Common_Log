...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-2.2.0-beta.17.xcframework.zip",
			checksum: "f247f52a67d1017b53e7f716c10a61aab7dceb12fd78a28e8665c32d69c6b7e9"
		)
	]
)