...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Log-1.3.5.xcframework.zip",
			checksum: "1dc6bb21e66aad95bc8d3e2228f342615d9e3abe1802eb91dd50c50eaafdae91"
		)
	]
)