...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-2.0.0-beta.24.xcframework.zip",
			checksum: "ba3df8e19a8197ff668f9df3cc920ec62b76ea69143cf447bc150700122627aa"
		)
	]
)