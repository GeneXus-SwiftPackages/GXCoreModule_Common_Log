...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_Log-4.2.0-rc.0.xcframework.zip",
			checksum: "fa3ab7704ea3aae75017fae8a7421e1bbf715c3d0bfff540c81a8eb7346657de"
		)
	]
)