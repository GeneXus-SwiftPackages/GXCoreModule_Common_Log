...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.2.0-beta.7.xcframework.zip",
			checksum: "c326f8020241ddec904b4df1be81d7d849a21d8ff45eb60eb6fa5026b0aea70a"
		)
	]
)