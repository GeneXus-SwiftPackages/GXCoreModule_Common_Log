...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-4.2.0-beta.19.xcframework.zip",
			checksum: "48c78aa6900a239ae1ef94f6a7e273b76e86cf6c492ee6b03e02762fcff55fa7"
		)
	]
)