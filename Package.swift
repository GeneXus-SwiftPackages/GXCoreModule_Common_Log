...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Log-4.1.0.xcframework.zip",
			checksum: "76d0aeec50963f2ce193c0eff382debfc45c1da6ffe0702b547f250fe71d4fa0"
		)
	]
)