...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.1.0-beta.7.xcframework.zip",
			checksum: "df90c4f563044d0d878930f30d442fff0d4f05b75a1ee7d8c2ed96716b185e9e"
		)
	]
)