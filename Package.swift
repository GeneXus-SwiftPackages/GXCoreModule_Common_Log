...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Log-2.1.4.xcframework.zip",
			checksum: "edf91cc6650270bd31443a85e4c4f575358550edcfdff5b21279192827c7b1ef"
		)
	]
)