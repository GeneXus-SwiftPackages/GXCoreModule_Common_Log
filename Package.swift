...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_Log-4.1.0-rc.3.xcframework.zip",
			checksum: "914fd96b1e89cf050c7996087e421c606e238f09611b6161eb2f86068fbb2d7a"
		)
	]
)