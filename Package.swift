...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-4.1.0-beta.13.xcframework.zip",
			checksum: "c54f0951c33a234fd8c5e727e86e147baef1508718b79efdbc3883cc0a4b87cf"
		)
	]
)