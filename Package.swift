...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.2.0-beta.36.xcframework.zip",
			checksum: "a8e0ca05ae9ac848d96874ef174d7c4547f33fce2763c21f5f12c31c2b314708"
		)
	]
)