...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Log-4.2.0.xcframework.zip",
			checksum: "0213e37a3545be374a6cd36dc434646d2fce31f2ef82b3976465f17223ec0d6e"
		)
	]
)