...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Log-4.0.2.xcframework.zip",
			checksum: "6122176398775c3e08930298f4c946889571c44977ae681cd7e435ddb848740a"
		)
	]
)