...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-2.1.0-beta.23.xcframework.zip",
			checksum: "fd89e6171ae63e9465d1d7ec467cfc41976f9de4d6f5af32bae2ef4d1332220b"
		)
	]
)