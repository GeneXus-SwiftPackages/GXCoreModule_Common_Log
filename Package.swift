...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-4.1.0-beta.19.xcframework.zip",
			checksum: "ba46abc77f350c8a601a42486a89f24971555a1cd33d71b4f5fd11c80648d193"
		)
	]
)