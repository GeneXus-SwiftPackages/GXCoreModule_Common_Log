...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.2.0-beta.13.xcframework.zip",
			checksum: "f1740c457f4a72052c92a5dfa3f07797caf3a8a9fe3465a64292a96ef43c5ae3"
		)
	]
)