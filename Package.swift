...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.0.0-beta.10.xcframework.zip",
			checksum: "80f63eb548aabf3d024b7f301e60fe7ffece0b30960e2daced1e00b768aef643"
		)
	]
)