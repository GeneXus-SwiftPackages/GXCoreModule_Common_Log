...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_Log-1.4.0-rc.21.xcframework.zip",
			checksum: "3b7e75a4da3198b2ca4963373ff38c13a6ffd50e0345e77b979a7d799ee8c534"
		)
	]
)