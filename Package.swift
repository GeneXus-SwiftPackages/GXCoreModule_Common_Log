...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Log-4.0.7.xcframework.zip",
			checksum: "532ab3847982b23cc639dcf98f2248eee4734f0908c3303c833ef1ee12e687aa"
		)
	]
)