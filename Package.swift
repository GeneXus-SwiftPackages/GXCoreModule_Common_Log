...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.2.0-beta.19.xcframework.zip",
			checksum: "648f0d953c5a5f4227437fdda47ca96da090f35a0d31583d27ef2c66a688440c"
		)
	]
)