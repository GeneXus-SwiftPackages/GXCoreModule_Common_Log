...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Log-4.0.8.xcframework.zip",
			checksum: "05a115a723790834ca8c96e9611db7a2e343f8f31d15a978e13990b80869b06d"
		)
	]
)