...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Log-4.0.0.xcframework.zip",
			checksum: "4074666e0c578ec9d7038b255e9947a764c000ec25e97ef908de555a8d89fc52"
		)
	]
)