...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-2.2.0-beta.8.xcframework.zip",
			checksum: "dd15801b8d981d74c9f25cfd54552d168e1ee025390d59a182a9a5a9042c39a7"
		)
	]
)