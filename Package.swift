...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.2.0-beta.9.xcframework.zip",
			checksum: "c7bebfe04f926e3cdbb4f6d5d947e4904792092c500c744bfe98ea1917c426d5"
		)
	]
)