...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.1.0-beta.32.xcframework.zip",
			checksum: "b77e6babec216f29fcc5b0f431f908aa22d449e32eee56c42e52cdd7bf1abf7d"
		)
	]
)