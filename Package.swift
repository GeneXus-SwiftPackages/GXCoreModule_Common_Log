...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.1.0-beta.5.xcframework.zip",
			checksum: "6fb8c9e43a76a5f960a750f2d986fe4139362a71bcd86217ee0a87262bf9ab4c"
		)
	]
)