...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_Log-3.2.0-rc.11.xcframework.zip",
			checksum: "bb4333d3bb23c70b69e61526a5b1b9da3e95754a4e085e6aebe05741a81c9b44"
		)
	]
)