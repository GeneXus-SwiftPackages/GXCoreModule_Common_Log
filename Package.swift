...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-2.0.0-beta.40.xcframework.zip",
			checksum: "a16f853175ded0d8bd3e7c6dc7fa30251dcbf43b58663574565edda9cda353e7"
		)
	]
)