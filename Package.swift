...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_Log-1.4.0-rc.5.xcframework.zip",
			checksum: "51a4edb86686ac23536529deb86df351ea6f67a96c923985c313307b85774dac"
		)
	]
)