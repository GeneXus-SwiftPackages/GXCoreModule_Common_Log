...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-4.2.0-beta.5.xcframework.zip",
			checksum: "d857089c82e8b9315e39aedbb4808ad7d75ebdbf924644dfa715b166169fd982"
		)
	]
)