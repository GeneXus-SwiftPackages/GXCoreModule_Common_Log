...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-4.2.0-beta.17.xcframework.zip",
			checksum: "2f40592da8f703e9fa74e4c65f3e0ab1c8a0dfb4ce92b35a32000cd4089416ba"
		)
	]
)