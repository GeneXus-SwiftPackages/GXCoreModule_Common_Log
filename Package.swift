...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Log-3.0.3.xcframework.zip",
			checksum: "6e5993707d01d3f5538cdc9e8e1a5043f97682304e884ff51b19b6d1e6abe6e5"
		)
	]
)