...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_Log-4.0.0-rc.43.xcframework.zip",
			checksum: "70cd8c9d99cf51a6e375f19872663e7181e481efbcc767181be4e440eba96b56"
		)
	]
)