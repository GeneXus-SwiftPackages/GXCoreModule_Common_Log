...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.0.0-beta.16.xcframework.zip",
			checksum: "13575c5a6ae0208696dc66de4a7c2e799ab6ddadfd1f2e7629dc32f54574cc6a"
		)
	]
)