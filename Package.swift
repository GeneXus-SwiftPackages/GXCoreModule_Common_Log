...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-4.2.0-beta.11.xcframework.zip",
			checksum: "1de57ad1846c9fa6821a47fb8fad7882358839c78123e8ea67beff98e63a20c1"
		)
	]
)