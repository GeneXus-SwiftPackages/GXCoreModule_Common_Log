...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.2.0-beta.14.xcframework.zip",
			checksum: "9915115df1f3101eecd15d614b5f6060cf53a741f558c6b7b4c6c77c6c4c6321"
		)
	]
)