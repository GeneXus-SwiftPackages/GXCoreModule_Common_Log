...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-2.2.0-beta.12.xcframework.zip",
			checksum: "882e1c4b1f102108b1689d349907a866a8576d951a902582a5b59bb2ad6a4903"
		)
	]
)