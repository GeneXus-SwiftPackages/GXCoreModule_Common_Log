...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-4.2.0-beta.24.xcframework.zip",
			checksum: "309be3cbc6f833466f9a7413444d66f461fd89a53a49db6d91ed119768138a6b"
		)
	]
)