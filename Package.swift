...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.2.0-beta.22.xcframework.zip",
			checksum: "0249f902d50ac7ef5d814577ea328a6f116f622935e1ab502d7353d3321b5688"
		)
	]
)