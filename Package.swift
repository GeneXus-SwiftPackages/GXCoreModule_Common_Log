...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Log-3.0.4.xcframework.zip",
			checksum: "14619a3dfec9bc0183dbe23018a1ee75fba0f26d7eca265cae4347a4a1ba0c5b"
		)
	]
)