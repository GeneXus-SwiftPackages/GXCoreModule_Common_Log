...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_Log-1.1.0-rc.4.xcframework.zip",
			checksum: "e49239eb7fcd0f3b6845044f073fc38f3b6a1aaba3607b74c5640848c3d68cf2"
		)
	]
)