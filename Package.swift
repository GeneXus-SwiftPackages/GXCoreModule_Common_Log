...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.1.0-beta.10.xcframework.zip",
			checksum: "08c7f8a54bb4db86136fa2b0d36686c4646bda80b522da7234e7c36107967fa0"
		)
	]
)