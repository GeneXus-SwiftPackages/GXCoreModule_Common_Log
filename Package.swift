...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Log-3.1.1.xcframework.zip",
			checksum: "f2d1aed45158788f00213fb33c384367be5f46cfe43ddea6f51f037084bbbed4"
		)
	]
)