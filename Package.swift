...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Log-1.4.31.xcframework.zip",
			checksum: "64efc497cb945470c16ccaef1ee47e5c40bb724bdd748271a0b805ba9e50c679"
		)
	]
)