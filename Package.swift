...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_Log-2.2.0-rc.1.xcframework.zip",
			checksum: "f3c89aeb78b2e9443de212f54b64dff8f71bc020a0068c93bb8fc78a5361849c"
		)
	]
)