...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_Log-1.6.0-rc.0.xcframework.zip",
			checksum: "e2bc77d21ee25d0f530b1cc11d504f1f672720e2f480a56db7543da374bea9ee"
		)
	]
)