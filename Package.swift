...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-2.0.0-beta.38.xcframework.zip",
			checksum: "62541ecf6139b23cd1d3fa742d91ae183ff8141f559134fdda3fb5fe0f813cc3"
		)
	]
)