...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.1.0-beta.5.xcframework.zip",
			checksum: "873ce90e325756aa7e49d25e50eb8eaba94172fc9c06df3016b73ea2c7305ef8"
		)
	]
)