...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-4.2.0-beta.3.xcframework.zip",
			checksum: "d5fd88ef85a766be8b90c8833fdca392cebd67996ffc17843f4b828dc365f55c"
		)
	]
)