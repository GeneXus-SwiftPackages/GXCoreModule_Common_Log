...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-4.2.0-beta.21.xcframework.zip",
			checksum: "4c266a1ea52965f35ce202541974af2a532066f8c964582a1fdf399605182d1f"
		)
	]
)