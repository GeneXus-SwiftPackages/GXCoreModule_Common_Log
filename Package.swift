...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Log-4.1.2.xcframework.zip",
			checksum: "4e257a313af18375429a018ce5659d4fd478cef03413e484228b1933898a709d"
		)
	]
)