...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.1.0-beta.24.xcframework.zip",
			checksum: "b5a2127e8b6eb36683374f9f29c0d3b682afac7a1aed9916520aa7e1f64503c9"
		)
	]
)