...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.0.0-beta+20230610052334.xcframework.zip",
			checksum: "df5936f0aa8742cd80e8b7903245741e5def799ca4390eaadccab162153c8014"
		)
	]
)