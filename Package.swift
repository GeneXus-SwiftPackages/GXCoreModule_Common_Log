...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.2.0-beta.11.xcframework.zip",
			checksum: "f4f8afc28f4e029318eeb4667c924423d7367b43d96e91bb550e5bc1e97d3ffc"
		)
	]
)