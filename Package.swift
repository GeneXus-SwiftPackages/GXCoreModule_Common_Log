...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Log-1.4.30.xcframework.zip",
			checksum: "25acca7b725c49f785465c449c04b6d3913b2275235c012608a423d469555859"
		)
	]
)