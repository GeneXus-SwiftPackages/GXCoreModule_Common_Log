...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-4.2.0-beta.22.xcframework.zip",
			checksum: "31cb3c1d67549ab4dcd612dfd9e34db97ed9b84e3194cfb6d398dceef47a5ce4"
		)
	]
)