...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Log-4.0.16.xcframework.zip",
			checksum: "7648ffcacb2d6eed865e7e1114dfeabb62f69da992b7cd4320321b7acaa16c6d"
		)
	]
)