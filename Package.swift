...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-2.0.0-beta.22.xcframework.zip",
			checksum: "df05f0fa59b349a68a921d53bcd4ea2c3cb2e3e7c5c4ba91ce39f31ac07f32fa"
		)
	]
)