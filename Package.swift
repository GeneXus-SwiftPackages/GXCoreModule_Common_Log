...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.0.0-beta.15.xcframework.zip",
			checksum: "ed655039373334ee51763652dbf370fd55c0eb77b3584867058093b12b5812c3"
		)
	]
)