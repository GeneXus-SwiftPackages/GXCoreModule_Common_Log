...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-5.0.0-beta.4.xcframework.zip",
			checksum: "92f1fae2176063104e4af3ddf5a1daeeaf13d968350604b9dbe65f0e8b5c2757"
		)
	]
)