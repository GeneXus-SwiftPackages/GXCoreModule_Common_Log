...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-2.0.0-beta.20.xcframework.zip",
			checksum: "3150a7872e11c6727bb4f122954f747c7647cd919795fa9009e4a9a7dbbc239b"
		)
	]
)