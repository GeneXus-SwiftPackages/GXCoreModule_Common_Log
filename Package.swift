...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Log-3.0.1.xcframework.zip",
			checksum: "385667455f5054bc0427358c298e5af9efbbf3547a085df73a93045193a1e00e"
		)
	]
)