...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.1.0-beta.794.xcframework.zip",
			checksum: "7f0046a5a0c5919af23aeb161e532e01a7f5712160d1b92ac69fa41afca6a59d"
		)
	]
)