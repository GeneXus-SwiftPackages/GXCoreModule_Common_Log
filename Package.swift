...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_Log-1.2.0-rc.36.xcframework.zip",
			checksum: "90eb53805394c0966080a25533c83fe146134658f52e75a012b8e498d50966b0"
		)
	]
)