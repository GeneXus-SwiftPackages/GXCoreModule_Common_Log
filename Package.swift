...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.1.0-beta.12.xcframework.zip",
			checksum: "54eaa71b99f3b02bad070413f40e8d14caa879173328fe868b913d788b0f823a"
		)
	]
)