...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-2.0.0-beta.17.xcframework.zip",
			checksum: "d8ecd8e3be814deb5ab2fe523e0f62b06e111e1543713da4519f113655dd23b7"
		)
	]
)