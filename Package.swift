...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.5.0-beta.11.xcframework.zip",
			checksum: "9cb7bb6021a9a074d8e394c8cc902bb428d08158b681183e3b86786a626553da"
		)
	]
)