...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_Log-2.0.0-rc.22.xcframework.zip",
			checksum: "20234c5a986f2c435fe10113312610aafd265e5e17f862e421422f687bfc4546"
		)
	]
)