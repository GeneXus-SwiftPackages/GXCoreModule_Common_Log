...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Log-4.0.9.xcframework.zip",
			checksum: "2b06f56c73948e8ae6593f4918d3c806eb997cce311db963a38a1a264c8fff13"
		)
	]
)