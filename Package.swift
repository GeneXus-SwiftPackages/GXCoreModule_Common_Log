...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.2.0-beta.32.xcframework.zip",
			checksum: "ee67a0aba3d402233ec79e90f231af83953b9fc0c3a2beac055c507823b7264e"
		)
	]
)