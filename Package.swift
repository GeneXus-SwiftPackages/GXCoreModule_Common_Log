...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-4.1.0-beta.18.xcframework.zip",
			checksum: "fe30dd860cf77855b1f024d388df8c9947abac7fcd8933fe3191ac883f7da974"
		)
	]
)