...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.2.0-beta.14.xcframework.zip",
			checksum: "f8b9ba8703ed0db58f441d2c23293daadcd5078dcd567733a4a5acb592dda808"
		)
	]
)