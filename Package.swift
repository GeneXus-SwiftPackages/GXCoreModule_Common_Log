...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_Log-3.2.0-rc.12.xcframework.zip",
			checksum: "dd9971a1df5930e4e7e0f6e4d2cdec80a9a13d0b128bd9da16811a211f389e5e"
		)
	]
)