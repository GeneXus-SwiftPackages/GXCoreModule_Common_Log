...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-2.0.0-beta.29.xcframework.zip",
			checksum: "1193d2543115809113c3d530ae6c828d8a064f5e28abc5d592aa1f9e94d9ea32"
		)
	]
)