...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-4.1.0-beta.12.xcframework.zip",
			checksum: "59b353d938e366093d81d5a0c71892cc9cb6122b171f08120a4bb17c489fbb91"
		)
	]
)