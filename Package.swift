...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-2.0.0-beta.31.xcframework.zip",
			checksum: "249b00afa6fcf1c6937c55bb3b1e998ae9ac6a2c48d13cdf16b81652f53a305b"
		)
	]
)