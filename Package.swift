...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-2.1.0-beta.24.xcframework.zip",
			checksum: "1e7e47ff7648960daf5206a8215766940ed9b46157e906d21684ebe439b17ce2"
		)
	]
)