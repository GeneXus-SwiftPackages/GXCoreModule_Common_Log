...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-2.2.0-beta.14.xcframework.zip",
			checksum: "430d96a485d5edbd0b6c8e4cc2366302da3770f6daeb1cb3528d3c390642b1c7"
		)
	]
)