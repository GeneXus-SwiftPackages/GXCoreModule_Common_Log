...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.5.0-beta.5.xcframework.zip",
			checksum: "316c085480b0bfe28910b1c553b8a525cc392e195ccc8100abcaeb57a496d020"
		)
	]
)