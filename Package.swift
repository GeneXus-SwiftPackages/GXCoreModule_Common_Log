...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-2.1.0-beta.25.xcframework.zip",
			checksum: "2af8f45ef11c146214dc2aa3f53852edebcd593d05cf960fe95cafca0f4f0f4f"
		)
	]
)