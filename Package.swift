...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-2.2.0-beta.15.xcframework.zip",
			checksum: "d77744b8b09c3e4d58466dbbe010e3ae9a299f74ab43abbb96d3360ff780614d"
		)
	]
)