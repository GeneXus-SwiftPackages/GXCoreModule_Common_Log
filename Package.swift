...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.1.0-beta.9.xcframework.zip",
			checksum: "cbf1f40889743aa852c1f6aa9268dee55918f5073fbb6f777db6e5caf2d1bc95"
		)
	]
)