...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.0.0-beta.14.xcframework.zip",
			checksum: "b3ca9ac4ae5b3106910f0997a810ba1f65cb6e6b0f0b61a2f6a721b5209133b8"
		)
	]
)