...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.3.0-beta.4.xcframework.zip",
			checksum: "90d0878473246caa52c3bc0a70b54f45b973f1c20e66a0611e82c8d7137bbc30"
		)
	]
)