...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.2.0-beta.27.xcframework.zip",
			checksum: "e1316eb41a4a04f01ab92400a23611fa080b03eabb66fa4a3197d5ecb1c2d729"
		)
	]
)