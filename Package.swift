...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Log-1.2.0.xcframework.zip",
			checksum: "4e22b219d12281a9d258b242ffe7a01f13242f7264ecf00021e2eaad303dd14f"
		)
	]
)