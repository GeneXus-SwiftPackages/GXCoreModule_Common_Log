...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-4.1.0-beta.7.xcframework.zip",
			checksum: "76bb9d3a40252d1e98743831a348a9320af852edfe7d59beb578895bbd07c418"
		)
	]
)