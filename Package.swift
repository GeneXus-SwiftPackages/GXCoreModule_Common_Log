...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_Log-1.5.0-rc.26.xcframework.zip",
			checksum: "ab5e901739ea58741c23e9addb2cab1b4b3d5472a97cabb51427c0f370db58cd"
		)
	]
)