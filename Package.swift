...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-2.0.0-beta.41.xcframework.zip",
			checksum: "100cd4899eb2c11590eae3b991335fbfe885bbeaf0caab4cf8f4b82227ed323f"
		)
	]
)