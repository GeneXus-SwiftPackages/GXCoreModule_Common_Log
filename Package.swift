...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Log-2.0.17.xcframework.zip",
			checksum: "766c99f2aa8d104e03e2ce0acb2e64e3d1f15d1c0e7f49e439ad1b6c66ab6f0b"
		)
	]
)