...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.5.0-beta.25.xcframework.zip",
			checksum: "3e0baac8a3eb4c67a8352d369ddc1e70bd8108762f063e067e396e68f1b064fa"
		)
	]
)