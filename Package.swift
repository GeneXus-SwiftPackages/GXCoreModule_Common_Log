...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.0.0-beta.11.xcframework.zip",
			checksum: "0b0deb1c9b689d70fa33c2eef7c61f7b7ed303b3add4ebbb508643a30c2c3d62"
		)
	]
)