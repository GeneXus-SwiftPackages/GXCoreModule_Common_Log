...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.1.0-beta.15.xcframework.zip",
			checksum: "557200cd0395f6c7a1282d1e18ad667c38e1032daab652a1ab058851bec200fe"
		)
	]
)