...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-2.0.0-beta.23.xcframework.zip",
			checksum: "9629eadf8651fdfb1ae2615e69332951bb79139ed148d050fd855faa2ccfa75a"
		)
	]
)