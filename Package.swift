...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.2.0-beta.30.xcframework.zip",
			checksum: "9430615e743a53d72cb494206708dd8b59c3da585ae4af37957e8d69e1fbba58"
		)
	]
)