...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.2.0-beta.20.xcframework.zip",
			checksum: "7b8cf1b5385111407080e3c19eaa018011315fb2d9f40174481ddbbf5f50d5b7"
		)
	]
)