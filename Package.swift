...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-4.2.0-beta.31.xcframework.zip",
			checksum: "8ff4dab53798cf6ae0e775655726134e03c91362677d08270c72c0e41d64322d"
		)
	]
)