...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_Log-2.1.0-rc.25.xcframework.zip",
			checksum: "6d90d27ae32806b462fdf52f7e869961cff8cb79ba433c43f1adb4ae319e5cfe"
		)
	]
)