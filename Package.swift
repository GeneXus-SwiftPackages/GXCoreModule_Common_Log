...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_Log-4.1.0-rc.22.xcframework.zip",
			checksum: "d9ddc54640b51e8a4c46b10ed0d746ce4235343b8dfea0fd487b33705b88ccb8"
		)
	]
)