...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.2.0-beta.25.xcframework.zip",
			checksum: "a9f28eb47f8daad845dfd10b0e92e999f3759b5de49dba28c8dcb78969f3ea94"
		)
	]
)