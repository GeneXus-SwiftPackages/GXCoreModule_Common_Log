...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_Log-1.2.0-rc.29.xcframework.zip",
			checksum: "8ba44bfacb51d2983af76850ebc2916ac0772e86b48999a0c980392723fec299"
		)
	]
)