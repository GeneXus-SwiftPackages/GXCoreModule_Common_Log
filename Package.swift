...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.4.0-beta.5.xcframework.zip",
			checksum: "1bef45f14862dc8b6265679796d5ec322c6c84142b54d0be9538d75942deb680"
		)
	]
)