...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.2.0-beta.11.xcframework.zip",
			checksum: "16731bb8a20e8bd8251ee8cefe0550c4c2cde7d7761605ccc3141f345e3966b4"
		)
	]
)