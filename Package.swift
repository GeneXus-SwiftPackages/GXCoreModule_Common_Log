...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-2.0.0-beta.32.xcframework.zip",
			checksum: "5c5ac3b5c52690af3e6815eb68d92466c0d6880af79338d242e7241b49fa95e3"
		)
	]
)