...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-4.1.0-beta.20.xcframework.zip",
			checksum: "0ecbe7a201ee9c5b8b975e48ae25b8669e0ee0255a832e527ad3989af50cd372"
		)
	]
)