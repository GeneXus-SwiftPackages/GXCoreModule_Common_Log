...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_Log-1.4.0-rc.1.xcframework.zip",
			checksum: "edbc934d558b241764acd404708080f3ae4221afaddbfaa6226651ffbbd34ac7"
		)
	]
)