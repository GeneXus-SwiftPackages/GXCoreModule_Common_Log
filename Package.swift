...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-2.2.0-beta.19.xcframework.zip",
			checksum: "c3bb1de539979e60cf87471b3009376438cc53866dd5eeddf933f6930d47c21c"
		)
	]
)