...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-1.5.0-beta.19.xcframework.zip",
			checksum: "5c1932e3d701b32be2a267de0eba946af02a6eaa53f899d0d7394be1629329c2"
		)
	]
)