...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_Log-3.1.0-rc.8.xcframework.zip",
			checksum: "7c23ee8f6036ecf25bbf0cc5254492e0be192ce014a7e5500b1530f8902e81a0"
		)
	]
)