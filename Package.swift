...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-2.0.0-beta.34.xcframework.zip",
			checksum: "0bb40f94d8a6d154c2e99d85ea00ae2623023001a59b6e09dd0e361de02c7c1a"
		)
	]
)