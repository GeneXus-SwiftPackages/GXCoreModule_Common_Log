...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-2.0.0-beta.28.xcframework.zip",
			checksum: "75d7c78a9cee4f82d9eb9a2fffef2b146cd48bff14c254aa7920fdc227c1f57e"
		)
	]
)