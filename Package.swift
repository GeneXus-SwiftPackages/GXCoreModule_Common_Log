...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-2.0.0-beta.16.xcframework.zip",
			checksum: "a378946e06e3c354d6bb41ba9806b968761c084945dd946ae16b45429b7223e9"
		)
	]
)