...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-4.1.0-beta.6.xcframework.zip",
			checksum: "9e70e5c786806fed9fb86ee9aef8d26a719d9c01245b72f1774af28596d239ff"
		)
	]
)