...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-2.2.0-beta.20.xcframework.zip",
			checksum: "97def682c33a1d7cf1a734a95dcadb22994178d17a60578d05f0c1347e81a768"
		)
	]
)