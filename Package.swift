...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_Log-2.0.0-rc.36.xcframework.zip",
			checksum: "21893477f4f391bd137d5f09effa1f8ec81932ff84d16f72ee63a3a73c9d58c5"
		)
	]
)