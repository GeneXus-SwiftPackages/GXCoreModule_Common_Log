...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-3.1.0-beta.10.xcframework.zip",
			checksum: "c7585672c9a9de205f13fabe5e5a117cbff42f91ae7581407ecb3183d757c168"
		)
	]
)