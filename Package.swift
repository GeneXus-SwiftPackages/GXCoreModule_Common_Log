...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Log-3.1.4.xcframework.zip",
			checksum: "159b9c0fbcbd0c8d0fc6cdb702cfef4af7639c084af915cf9f2677f8c5e6d4a2"
		)
	]
)