...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Log-2.0.0-beta.19.xcframework.zip",
			checksum: "6005d7b7e1b8a1f1dce2b234b99e734c27da69476bd459769727e33306abed32"
		)
	]
)