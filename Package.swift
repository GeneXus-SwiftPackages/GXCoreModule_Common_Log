...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Log",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Log-3.0.0.xcframework.zip",
			checksum: "76d34338fad99548d7d764cfa1d71c3c195c05cba2aebed53f31af7310f3485d"
		)
	]
)